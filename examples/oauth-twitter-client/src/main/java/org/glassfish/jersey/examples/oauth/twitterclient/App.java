...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        OAuth1ClientFilterFeature filterFeature;
        if (PROPERTIES.getProperty(PROPERTY_TOKEN) == null) {
            ...
            PROPERTIES.setProperty(PROPERTY_TOKEN, accessToken.getAccessToken());
            ...
            filterFeature = authFlow.getOAuth1FilterFeature();
        } else {
            ...
            filterFeature = OAuth1ClientSupport.builder(consumerCredentials).buildFilterFeature()
                    .setAccessToken(storedToken).build();
        }
