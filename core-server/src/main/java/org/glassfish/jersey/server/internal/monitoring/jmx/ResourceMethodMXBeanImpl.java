...
public class ResourceMethodMXBeanImpl implements ResourceMethodMXBean {
     ...
     * @param exposePath {@code true} if the {@link org.glassfish.jersey.server.monitoring.ResourceMethodMXBean#getPath()}
     *                               should be exposed or if it should be always {@code null}.
     * @param mBeanExposer MBean exposer.
     * @param parentName Name of the parent bean.
     */
    public ResourceMethodMXBeanImpl(ResourceMethodStatistics methodStatistics, boolean exposePath,
