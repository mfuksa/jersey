...
/**
 * Feature that enables calculating of {@link MonitoringStatistics monitoring statistics}. The feature can be also
 * enabled by property {@link org.glassfish.jersey.server.ServerProperties#MONITORING_STATISTICS_ENABLED}.
 * <p/>
 * The feature is necessary when injection of {@link MonitoringStatistics monitoring statistics} is needed or
 * when {@link MonitoringStatisticsListener} should be called with new statistics.
 *
