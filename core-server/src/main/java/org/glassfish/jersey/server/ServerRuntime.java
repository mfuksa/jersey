...
class ServerRuntime {
    ...
    private static class Responder {
        ...
        public void process(Throwable throwable) {
            ...
            request.getRequestEventBuilder().setException(throwable, RequestEventImpl.ExceptionCause.STANDARD_PROCESSING);
            ...
            try {
                ...
                try {
                    ...
                    request.getRequestEventBuilder().setException(respError, RequestEventImpl.ExceptionCause.MAPPED_RESPONSE_PROCESSING);
                    request.triggerEvent(RequestEventImpl.Type.ON_EXCEPTION);
                    throw respError;
                }
