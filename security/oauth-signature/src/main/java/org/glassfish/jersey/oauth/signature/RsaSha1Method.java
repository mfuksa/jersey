 ...
 */
public final class RsaSha1Method implements OAuthSignatureMethod {
     ...
     */
    @Override
    public String sign(String baseString, OAuthSecrets secrets) throws InvalidSecretException {
