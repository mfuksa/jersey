...
public class SignatureTest {
    ...
    public void testHMACSHA1() {
        final OAuthSignature oauthSignature = getoAuthSignature();
    ...
    private OAuthSignature getoAuthSignature() {
        ServiceLocator serviceLocator = Injections.createLocator(new OAuthSignatureFeature.Binder());
        return serviceLocator.getService(OAuthSignature.class);
    }
