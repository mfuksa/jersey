 ...
 */
class OAuthSecurityContext implements SecurityContext {
    private final OAuthConsumer consumer;
    private final OAuthToken token;
    private final boolean isSecure;

    /**
     * Create a new OAuth security context from {@link OAuthConsumer consumer}.
     *
    ...
    /**
     * Create a new OAuth security context from {@link OAuthToken Access Token}.
