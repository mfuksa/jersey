...
public final class OAuthProperties {
     ...
     * </p>
     **/
    public static final String REALM = "jersey.config.server.oauth.realm";
     ...
     * </p>
     **/
    public static final String IGNORE_PATH_PATTERN = "jersey.config.server.oauth.ignorePathPattern";
     ...
     *
     **/
    public static final String MAX_AGE = "jersey.config.server.oauth.maxAge";
     ...
     *
     * */
    public static final String GC_PERIOD = "jersey.config.server.oauth.gcPeriod";
     ...
     * or {@link javax.ws.rs.core.Response.Status#UNAUTHORIZED}) the {@link OAuthServerFilter OAuth filter}
     ...
     * </p>
     * */
    public static final String NO_FAIL = "jersey.config.server.oauth.noFail";
     ...
     * </p>
     */
    public static final String ENABLE_TOKEN_RESOURCES = "jersey.config.server.oauth.resource.enabled";
     ...
     * </p>
     */
    public static final String REQUEST_TOKEN_URI = "jersey.config.server.oauth.resource.requestToken.uri";
     ...
     * </p>
     */
    public static final String ACCESS_TOKEN_URI = "jersey.config.server.oauth.resource.accessToken.uri";
}
