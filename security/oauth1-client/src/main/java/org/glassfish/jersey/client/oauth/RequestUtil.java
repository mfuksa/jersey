...
class RequestUtil {
     ...
     * @return a {@link javax.ws.rs.core.MediaType} object representing the media type of the request.
     */
    private static MediaType getMediaType(ClientRequestContext request) {
