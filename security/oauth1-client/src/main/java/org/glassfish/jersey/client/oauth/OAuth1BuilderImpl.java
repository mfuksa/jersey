...
class OAuth1BuilderImpl implements OAuth1Builder {
    ...
    @Override
    public OAuth1BuilderImpl setSignatureMethod(String signatureMethod) {
        params.setSignatureMethod(signatureMethod);
        return this;
    }

    @Override
    public OAuth1BuilderImpl setRealm(String realm) {
        params.setRealm(realm);
        return this;
    }

    @Override
    public OAuth1BuilderImpl setTimestamp(String timestamp) {
        params.setTimestamp(timestamp);
        return this;
    }

    @Override
    public OAuth1BuilderImpl setNonce(String timestamp) {
        params.setNonce(timestamp);
        return this;
    }

    @Override
    public OAuth1BuilderImpl setVersion(String timestamp) {
    ...
    static class FilterBuilderImpl implements FilterFeatureBuilder {
         ...
         */
        FilterBuilderImpl(OAuthParameters params, OAuthSecrets secrets) {
            this.params = params;
