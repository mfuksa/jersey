 ...
 * The feature registers {@link OAuthSignatureFeature} and {@link OAuthClientFilter} which
 * is passed to the feature in the constructor.
 *
...
public class OAuthClientFeature implements Feature {
     ...
     * @see OAuthClientFilter for information about how to configure the filter.
     */
    public OAuthClientFeature(OAuthClientFilter oAuthClientFilter) {
