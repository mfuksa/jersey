...
final class OAuthClientFilter implements ClientRequestFilter, ClientResponseFilter {
    ...
    public OAuthClientFilter(OAuthParameters parameters,
        ...
        if (parameters.getToken() != null && secrets.getTokenSecret() == null) {
            throw new IllegalStateException(LocalizationMessages.ERROR_CONFIGURATION_MISSING_TOKEN_SECRET());
        }
    ...
    public void filter(ClientRequestContext request) throws IOException {
        ...
        if (!signOnly) {
            if (state == State.NOT_AUTHORIZED_YET) {
                ...
                final Client client = ClientBuilder.newBuilder().register(new OAuthClientFeature(this)).build();
