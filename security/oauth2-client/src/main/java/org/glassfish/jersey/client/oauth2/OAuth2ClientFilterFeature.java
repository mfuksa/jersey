 ...
 * is defined in this class as a static variables ({@link #OAUTH2_PROPERTY_ACCESS_TOKEN} (see its javadoc for usage).
 ...
 * @since 2.3
 */
public class OAuth2ClientFilterFeature implements Feature {
    /**
     ...
     * </p>
     */
    public static String OAUTH2_PROPERTY_ACCESS_TOKEN = "JERSEY-OAUTH2-ACCESS-TOKEN";
     ...
     */
    public OAuth2ClientFilterFeature(String accessToken) {
     ...
     * specified by {@link #OAUTH2_PROPERTY_ACCESS_TOKEN} for each request otherwise no {@code Authorization}
     * http header will be added.
     */
    public OAuth2ClientFilterFeature() {
     ...
     */
    OAuth2ClientFilterFeature(OAuth2ClientFilter filter) {
        this.filter = filter;
    }
