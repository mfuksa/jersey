 ...
 * by {@link OAuth2CodeGrantFlow.Builder#setRedirectUri(String)} and provide the {@code code} and {@code state} as
...
public interface OAuth2CodeGrantFlow {
    ...
    /**
     * Return the {@link OAuth2ClientFilterFeature oauth filter feature} that can be used to configure
     ...
     * </p>
     *
     * @return {@code OAuth1ClientFilterFeature} configured with received {@code AccessToken}
     */
    ...
    public interface Builder<T extends Builder> {
         ...
         */
        T setAccessTokenUri(String accessTokenUri);
         ...
         * @return Builder instance.
         */
        T setAuthorizationUri(String authorizationUri);
         ...
         * @return Builder instance.
         */
        T setClientIdentifier(ClientIdentifier clientIdentifier);
         ...
         * it will be the same as URI defined in {@link #setAccessTokenUri(String)} (which is the default value
         ...
         * @return Builder instance.
         */
        T setRefreshTokenUri(String refreshTokenUri);
