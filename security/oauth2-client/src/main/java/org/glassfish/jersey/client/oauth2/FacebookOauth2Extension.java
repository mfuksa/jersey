 ...
 * @since 2.3
 */
public class FacebookOauth2Extension {
     ...
     */
    public static OAuth2CodeGrantFlow.Builder getFacebookAuthorizerBuilder(ClientIdentifier clientIdentifier,
                                                                           String redirectURI) {
        return getFacebookAuthorizerBuilder(clientIdentifier, redirectURI, ClientBuilder.newClient());
    }
    ...
    public static OAuth2CodeGrantFlow.Builder getFacebookAuthorizerBuilder(ClientIdentifier clientIdentifier,
        ...
        builder.setAccessTokenUri("https://graph.facebook.com/oauth/access_token");
        builder.setAuthorizationUri("https://www.facebook.com/dialog/oauth");
        builder.setRedirectUri(redirectUri);
        builder.setClientIdentifier(clientIdentifier);
    ...
    @Consumes("text/plain")
    public static class FacebookTokenMessageBodyReader implements MessageBodyReader<TokenResult> {
